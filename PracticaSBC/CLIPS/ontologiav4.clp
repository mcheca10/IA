...
(defclass Solicitante
    ...
    (slot nombre_usuario (type STRING) (create-accessor read-write))
    ...
    ;;; --- 2. ECONÓMICO ---
    (slot ingresos_mensuales (type FLOAT) (create-accessor read-write))
    ...
    (slot dias_para_mudanza (type INTEGER) (create-accessor read-write))
    ...
    (slot num_coches (type INTEGER) (default 0) (create-accessor read-write))
    (slot num_motos (type INTEGER) (default 0) (create-accessor read-write))
    ...
    (multislot busca_vivienda (type SYMBOL) (create-accessor read-write))
    ...
    (slot poder_adquisitivo (type SYMBOL) (allowed-values ALTO MEDIO BAJO) (create-accessor read-write))
    (slot nivel_urgencia (type SYMBOL) (allowed-values ALTA MEDIA BAJA) (create-accessor read-write))
    (slot exigencia_termica (type SYMBOL) (allowed-values NORMAL CRITICA) (create-accessor read-write))
    (slot demanda_accesibilidad (type SYMBOL) (allowed-values TOTAL NULA) (create-accessor read-write))
)
...
(defclass Vivienda
    ...
    (slot calidad_termica (type SYMBOL) (allowed-values ALTA MEDIA BAJA RIESGO) (create-accessor read-write))
    (slot nivel_accesibilidad (type SYMBOL) (allowed-values TOTAL PARCIAL NULA) (create-accessor read-write))
)

;;; SUBCLASES VIVIENDA
(defclass Bloque (is-a Vivienda) (role concrete) (pattern-match reactive)
    (slot gastos_comunidad (type FLOAT) (default 0.0) (create-accessor read-write)))
